    ...
    <div className="min-h-screen bg-zinc-50 flex flex-col md:flex-row">
      ...
      <nav className="w-full md:w-64 bg-white border-r border-zinc-200 p-4 flex flex-col gap-2">
        <div className="flex items-center gap-3 px-4 py-6 mb-4">
          ...
          <h1 className="text-xl font-bold text-zinc-900 tracking-tight">SolarInstall</h1>
        </div>
          ...
          {activeTab === 'dashboard' && (
            ...
            >
              <header className="flex justify-between items-center">
                <div>
                  <h2 className="text-2xl font-bold text-zinc-900">Bem-vindo, Instalador</h2>
                  <p className="text-zinc-500">Aqui está o resumo das suas atividades.</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <StatCard icon={<Users className="text-emerald-600" />} label="Clientes" value={customers.length.toString()} color="bg-emerald-50" />
                    ...
                    budgets.slice(0, 5).map(budget => (
                      <div key={budget.id} className="flex items-center justify-between p-4 bg-zinc-50 rounded-xl">
                        ...
                        <div className="text-right">
                          ...
                          <p className="font-bold text-emerald-700">R$ {budget.totalAmount.toLocaleString('pt-BR')}</p>
                        </div>
                      </div>
                    ))
                  )}
          ...
          {activeTab === 'customers' && (
            ...
            >
              ...
              {(isAddingCustomer || editingCustomer) && (
                <Card title={editingCustomer ? "Editar Cliente" : "Cadastrar Cliente"} className="border-emerald-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {customers.map(customer => (
                  <Card key={customer.id} className="hover:border-emerald-200 transition-colors">
          ...
          {activeTab === 'suppliers' && (
            ...
            >
              ...
              {(isAddingSupplier || editingSupplier) && (
                <Card title={editingSupplier ? "Editar Fornecedor" : "Cadastrar Fornecedor"} className="border-emerald-200">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                {services.map(service => (
                                  <button
                                    ...
                                    className="flex items-center justify-between p-3 bg-white border border-zinc-200 rounded-xl hover:border-emerald-500 hover:bg-emerald-50 transition-all text-left"
                                  >
                          ...
                          {Object.entries(newBudget.checklist || {}).map(([item, checked]) => (
                            <button
                              ...
                              className={cn(
                                ...
                                checked ? "bg-emerald-50 border-emerald-200 text-emerald-700" : "bg-white border-zinc-200 text-zinc-600"
                              )}
                            >
                              <div className={cn(
                                "w-5 h-5 rounded flex items-center justify-center border",
                                checked ? "bg-emerald-600 border-emerald-600 text-white" : "border-zinc-300"
                              )}>
                    ...
                    <Card key={budget.id} className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => setSelectedBudget(budget)}>
                      <div className="flex flex-col md:flex-row justify-between gap-4">
                        <div className="flex gap-4">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              <span className="px-2 py-0.5 bg-emerald-100 text-emerald-700 rounded-full text-[10px] font-bold uppercase">Aprovado</span>
                        ...
                        <div className="flex flex-col items-end justify-center gap-1">
                          ...
                          <p className="text-2xl font-black text-emerald-700">R$ {budget.totalAmount.toLocaleString('pt-BR')}</p>
